  ...
  return (
    <div className="mx-auto w-full max-w-2xl px-4 py-10">
      ...
      >
        ...
        <SubmitModeToggle
          label={t("zh", "submit.mode.label")}
          helper={t("zh", "submit.mode.note")}
          existingLabel={t("zh", "submit.mode.existing")}
          newLabel={t("zh", "submit.mode.new")}
          existingSlot={
          ...
          newSlot={
            ...
            >
              <div className="text-sm font-semibold">{t("zh", "submit.new.title")}</div>
